...
public class AddDietActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //---------- findViewById
        page_calendar = (ImageButton) findViewById(R.id.page_calendar);
        ...
        //--------- 버튼~리스너 연결
        page_calendar.setOnClickListener(this);
    ...
    public void onClick(View view){
        if (view.getId() == R.id.page_calendar){
            // 페이지 전환 : 뒤로가기
            finish();
        }else{
            // 페이지 전환 : 아침/점심/저녁을 클릭 -> 식단 입력
